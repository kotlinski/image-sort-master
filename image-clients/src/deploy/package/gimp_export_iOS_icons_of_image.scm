...
(define (export-image-as-app-icons-for-devices inImage inDrawable inPath iniPadIcons iniPhoneIcons)
    ...
    (if (or (= 1 iniPadIcons) (= 1 iniPhoneIcons))
        (begin
          (export-as-ios-image inImage inDrawable inPath "icon_512x512@2x.png" 1024 1024)
          (export-as-ios-image inImage inDrawable inPath "icon_512x512.png" 512 512)
          (export-as-ios-image inImage inDrawable inPath "icon_256x256@2x.png" 512 512)
          (export-as-ios-image inImage inDrawable inPath "icon_256x256.png" 256 256)
          (export-as-ios-image inImage inDrawable inPath "icon_128x128@2x.png" 256 256)
          (export-as-ios-image inImage inDrawable inPath "icon_128x128.png" 128 128)
          (export-as-ios-image inImage inDrawable inPath "icon_64x64@2x.png" 128 128)
          (export-as-ios-image inImage inDrawable inPath "icon_64x64.png" 64 64)
          (export-as-ios-image inImage inDrawable inPath "icon_32x32@2x.png" 64 64)
          (export-as-ios-image inImage inDrawable inPath "icon_32x32.png" 32 32)
          (export-as-ios-image inImage inDrawable inPath "icon_16x16@2x.png" 32 32)
          (export-as-ios-image inImage inDrawable inPath "icon_16x16.png" 16 16)))
    (if (= 1 iniPadIcons)
        (begin
